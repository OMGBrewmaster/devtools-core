...
lint:
	shellcheck Tools/check-agent-surfaces.sh Tools/check-docs-work-conformance.sh Tools/check-markdown-links.sh Tools/check-skill-roster-freshness.sh Tools/docs-only-diff.sh Tools/migrate-kaizen-journal.sh Tools/sync-skill-symlinks.sh Tools/hooks/post-checkout Tools/hooks/post-merge Tools/hooks/post-rewrite Tools/devcontainer/build/lib.sh Tools/devcontainer/build/setup.sh Tools/devcontainer/build/harness-claude.sh Tools/devcontainer/build/harness-codex.sh Tools/devcontainer/build/harness-omp.sh Tools/devcontainer/update-harnesses.sh Tools/devcontainer/validate_setup.sh tests/*.sh
