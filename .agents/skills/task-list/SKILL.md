...
A task with bold-metadata lines (`**Status**: Not Started`) instead of frontmatter predates the 2026-07 format convergence — extract the equivalent fields, and note at the end of the report that `devtools/Tools/migrate-task-format.sh` converts the repo.
